...
class CosmicBody():
    ...
    def __init__(self, mass: float = 10, vec_p=(0, 1000, 0), vec_v=(0, 0, 0)):
        self.exist = 1
        self.mass = mass
...
if __name__ == '__main__':
    ...
    def test_trajectory():
        ...
        mass = 0.1
        energy = mass * ((Norm(velosity)**2 / 2 - G *
                         Sun.getMass()/Norm(coordinates)))
    ...
    def test_3DMotion_2Bodies():
        """
        3D discrete morion of 2 Cosmic Bodies. Parametres chosen to demonstrate their 
        spining araound each other

        """
        velosity = [(2, 0, -1), (-3, 0, 2)]
        Ast1 = CosmicBody(12, (0, 0, 2), velosity[0])
        Ast2 = CosmicBody(16, (0, 5, -1), velosity[1])
        x1 = [Ast1.getPosition()[0]]
        y1 = [Ast1.getPosition()[1]]
        z1 = [Ast1.getPosition()[2]]
        x2 = [Ast2.getPosition()[0]]
        y2 = [Ast2.getPosition()[1]]
        z2 = [Ast2.getPosition()[2]]
        ...
        while t < dt*n:
            ...
            x1.append(Ast1.getPosition()[0])
            y1.append(Ast1.getPosition()[1])
            z1.append(Ast1.getPosition()[2])
            x2.append(Ast2.getPosition()[0])
            y2.append(Ast2.getPosition()[1])
            z2.append(Ast2.getPosition()[2])
